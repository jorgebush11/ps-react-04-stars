...
const useGameState = () => {
	...
	return { stars, availableNumbers, candidateNums, secondsLeft, setGameState };
};
...
const StarMatch = () => {
	const [gameId, setGmameId] = useState(1);

	return <Game key={gameId} startNewGame={() => setGmameId(gameId + 1)} />;
};
